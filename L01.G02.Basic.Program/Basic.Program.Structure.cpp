...
#include<iostream> 
				/* 
				 * The line above is called an include statement, and is an example of 
...
int main()
{
				  ...
				  */
    //Initialization is when we assign a value on creation.
	//Use {} initialization to indicate it IS initialization
	//and not assignment.
	int width{0}; 
	int height{0};
				 /*
